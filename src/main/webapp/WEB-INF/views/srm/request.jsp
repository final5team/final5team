					...
					<form method="post" action="${pageContext.request.contextPath}/customer/request" enctype="multipart/form-data">
						...
						<section class="section2">
							...
							<article class="inputData2">
								...
								<div class="item">
									<input type="date" class="form-control form-control-user" id="reqExpectDate" name="reqExpectDate" value="<fmt:formatDate value="${request.reqDate}" pattern="yyyy-MM-dd" />"><i class="fa fa-phone"></i>
								</div>
							</article>
							...
							<article class="titleInput">
								<div class="item">
									<input type="text" id="reqTitle" name="reqTitle" value="${request.reqTitle}">
								</div>
							</article>
