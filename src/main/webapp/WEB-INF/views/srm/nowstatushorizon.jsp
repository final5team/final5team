...
<c:if test="${request.statusName != '반려'}">
	<c:if test="${requestProcess.reqType == null || requestProcess.reqType == '정규'}">
		<div class="">
           <span class="circle done">요청완료</span>
           ...
           <span class="bar <c:if test="${request.statusNo >= 2}">active</c:if>"></span>
           <span class="circle
           ...
           <span class="bar <c:if test="${request.statusNo >= 5}">active</c:if>"></span>
           <span class="circle
           ...
           <span class="bar <c:if test="${request.statusNo >= 7}">active</c:if>"></span>
           <span class="circle
           ...
           <span class="bar <c:if test="${request.statusNo >= 9}">active</c:if>"></span>
           <span class="circle
           ...
           <span class="bar <c:if test="${request.statusNo >= 11}">active</c:if>"></span>
           <span class="circle
